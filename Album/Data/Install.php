           ...
           <?php else : ?>
                ...
                <div class="typecho-install-body">
                    <div class="message success">恭喜！插件已经安装完成！</div>
										<p>源码：<a href="https://plsYou.com" target="_bank">我本奈何 modify by gogobody</a> <br>前端：<a href="http://" target="_bank">章萧醇</a> </p>
...
<div class="typecho-foot" role="contentinfo">
    ...
    <nav class="resource">&bull;
       源码：<a href="http://way.so" target="_bank">我本奈何 modify by gogobody</a> &bull;
